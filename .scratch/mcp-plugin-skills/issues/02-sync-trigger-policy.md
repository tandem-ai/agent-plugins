...
No automatic trigger. Hooks are removed from the plugin (2026-09-08): Tandem does not force behaviour on the user's assistant. `sync` runs when the user asks; the document is reviewed before it is written.
