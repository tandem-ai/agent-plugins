...
3. Send the link `https://app.usetandem.com/<account.slug>/integrations?integration=<integration_key>` and say the key or authorization is entered there, never in this chat.
