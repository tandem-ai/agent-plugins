...
3. Send the link `https://app.stage.usetandem.ai/<account.slug>/integrations?integration=<integration_key>` and say the key or authorization is entered there, never in this chat.
