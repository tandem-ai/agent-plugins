...
Point the user to the Integrations page in the app (`https://app.stage.usetandem.ai/<account.slug>/integrations`), where a failed connection can be reconnected, and continue with the next provider.
